...
par(mfrow=c(1, 3))
layout(matrix(c(1,2,3), 1), widths = c(2, 2, 2.7))
brk = sigGenesHeatmap(objLP, 1, TRUE, 500, "LineagePulse")
sigGenesHeatmapLoess(PvalP.adj, 1, TRUE, 500, "Loess Parametric", brk, FALSE)
...
sigGenesHeatmapLoess(PvalP.adj, 1, FALSE, 500, "Loess Parametric", brk, FALSE)
...
sigGenesHeatmapLoess(PvalP.adj, 2, TRUE, 500, "Loess Parametric", brk, FALSE)
...
sigGenesHeatmapLoess(PvalP.adj, 2, FALSE, 500, "Loess Parametric", brk, FALSE)
